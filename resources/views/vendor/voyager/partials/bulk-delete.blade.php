<a class="jf-dash-btn jf-dash-btn--rose" id="bulk_delete_btn">
    <i class="voyager-trash"></i>
    <span class="jf-pill-label">{{ __('voyager::generic.bulk_delete') }}</span>
</a>

{{-- Bulk delete modal --}}
<div class="modal modal-danger fade jf-wallets-modal jf-users-bulk-delete-modal" tabindex="-1" id="bulk_delete_modal" role="dialog">
